...
st.caption("Heuristic index, adjustable below -- not a validated economic metric. Full methodology: Data Sources & Caveats.")
...
st.caption("Set a weight to 0 to drop that signal entirely.")
...
if level == "Canton (26)":
    ...
    st.caption(
        "Only vacancy is genuine district data -- the rest is parent-canton context. Nine cantons "
        "(Zug, Genève, Basel-Stadt, ...) have no Bezirk subdivisions and appear here as a single "
        "canton-wide entry. Details: Data Sources & Caveats."
    )
